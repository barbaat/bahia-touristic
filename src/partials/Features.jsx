...
function Features() {
  ...
  return (
    <section id="experiencias" className="relative py-12 md:py-16" aria-labelledby="beneficios-titulo">
      <div className="container-shell">
        <div className="mx-auto max-w-3xl text-center" data-aos="fade-up">
          <span className="kicker">Por qué elegir La Bahía</span>
          <h2 id="beneficios-titulo" className="mt-3 text-3xl font-bold text-slate-900 md:text-4xl">
        ...
        <div className="mt-8 grid gap-4 md:mt-10 md:grid-cols-3">
          {features.map((feature, index) => (
            <article
              key={feature.title}
              className="surface-card group h-full p-6 transition duration-300 hover:-translate-y-1 hover:shadow-xl"
              data-aos="fade-up"
